...
def runEuler():
    ...
    infile_name = "testInitial2nd.cfg"
    infile = open(infile_name)
    lines = infile.readlines()
    ...
    pylab.subplot(2,3,1)
    pylab.title("Initial Rho 2nd")
    pylab.plot(x,rho)
    pylab.subplot(2,3,2)
    pylab.title("Initial E 2nd")
    pylab.plot(x,E)
    pylab.subplot(2,3,3)
    pylab.title("Initial px 2nd")
    pylab.plot(x,px)

    #Final Conditions 2nd Order

    
    infile_name = "testFinalCons2nd.cfg"
    infile = open(infile_name)
    lines = infile.readlines()
    ...
    infile_name = "testFinalPrim2nd.cfg"
    infile = open(infile_name)
    lines = infile.readlines()
    ...
    pylab.subplot(2,3,5)
    pylab.title("Final Pressure 2nd")
    pylab.plot(x,pre)
    pylab.subplot(2,3,6)
    pylab.title("Final Velocity 2nd")
    pylab.plot(x,vx)
