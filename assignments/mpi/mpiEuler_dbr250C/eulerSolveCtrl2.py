...
N_points = 500;
dPx = .01;
InitialPwave(N_points+2, dPx, "run/initialIn.cfg")
InitialPwave(N_points+4, dPx, "run/initialIn2.cfg")

changeParamEntry("Nx", N_points)
changeParamEntry("runTime",.01)
...
dt = .8
runEuler6times(dt, "run/testFinalPrim2nd.cfg")
pylab.show()
